...
q1_20 = mock3_list[0:20]

with open("c:/Users/kj anand/Downloads/Quiz DD/mock3_1_20.json", "w", encoding="utf-8") as f:
    json.dump(q1_20, f, indent=4)
    
print("Extracted", len(q1_20), "questions.")
