var dataQuizData = {
    data1: [
        {
            ...
            options: ['Big Data', 'Imputed Data', 'Qualitative Data', 'Continuous data'],
            a: 0,
        },
        {
            id: 2,
        ...
        },
        {
            ...
            options: ['Metric 1', 'Metric 2', 'Metric 3', 'Metric 4', 'Metric 5', 'Metric 6'],
        ...
        },
        {
            ...
            options: ['Metadata', 'Quantitative data', 'Ordinal Data', 'Qualitative data'],
            a: 1,
        },
        {
            id: 5,
        ...
        },
        {
            ...
            options: ['List', 'One-dimensional Array', 'Table', 'Series'],
            a: 2,
        },
        {
            id: 9,
            ...
            options: ['Table', 'List', 'Multi-dimensional array', 'Graph'],
            a: 1,
        },
        {
            id: 10,
    ...
    data2: [
        {
            ...
            options: ['Granularity', 'Transparency', 'Interpretability', 'Completeness'],
            a: 0,
            marks: 2,
        },
        {
        ...
        },
        {
            ...
            options: ['Filters', 'Values', 'Rows', 'Columns'],
            a: 2,
            marks: 1,
        },
        {
        ...
        },
        {
            ...
            options: ['Sorting', 'Aggregation', 'Pivoting', 'Filtering'],
            a: 0,
            marks: 2,
        },
        {
            ...
            options: ['Truncating', 'Transposing', 'Filtering', 'Deleting'],
            a: 2,
            marks: 2,
        },
        {
    ...
    data3: [
        ...
        },
        {
            ...
            options: ['Python', 'Microsoft Word', 'Power Query for Excel (M)', 'JSON'],
            a: [0, 2],
            marks: 2,
        },
        {
        ...
        },
        {
            ...
            type: 'MCQ',
            q: 'What concept allows analysts to drill down into data and examine different levels of information that may be crucial in diagnostic analytics?',
            options: ['Completeness', 'Transparency', 'Interpretability', 'Granularity'],
            a: 3,
            marks: 2,
        },
        {
        ...
        },
        {
            ...
            options: ['Hours', 'Weeks', 'Years', 'Months', 'Days'],
            a: 0,
            marks: 2,
        },
        {
    ...
    data4: [
        ...
        },
        {
            ...
            optionImages: ['v3_q6_optA.png', 'v3_q6_optB.png', 'v3_q6_optC.png', 'v3_q6_optD.png'],
            options: ['Option 3', 'Option 1', 'Option 2', 'Option 4'],
            a: 2,
        },
        {
            id: 6,
            ...
            options: ['Distributing', 'Disaggregating', 'Unpivoting', 'Pivoting'],
            a: 1,
        },
        {
            id: 7,
        ...
        },
        {
            ...
            options: ['Option 3', 'Option 4', 'Option 1', 'Option 2'],
            a: 1,
        },
        {
            id: 13,
        ...
        },
        {
            ...
            options: ['Bar chart', 'Column chart', 'Line chart', 'Bubble chart'],
            a: [0, 1],
        },
        {
            id: 19,
        ...
        },
        {
            ...
            options: ['Bubble chart', 'Scatter chart', 'Waterfall chart', 'Area chart'],
            a: 0,
        },
        {
            id: 21,
    ...
    data5: [
        ...
        },
        {
            ...
            options: ['Years', 'Months', 'Days', 'Weeks', 'Hours'],
            a: 4,
        },
        {
            id: 9,
        ...
        },
        {
            ...
            options: ['Big Data', 'Continuous Data', 'Qualitative Data', 'Imputed Data'],
            a: 0,
        },
        {
            id: 11,
        ...
        },
        {
            ...
            options: ['Anchoring bias', 'Motivated Reasoning', 'Affinity bias', 'Sampling bias'],
            a: 1,
        },
        {
            id: 17,
    ...
    da_mock1: [
        ...
        },
        {
            ...
            options: ['Transposing', 'Filtering', 'Deleting', 'Truncating'],
            a: 1,
        },
        {
            id: 4,
        ...
        },
        {
            ...
            type: 'MCQ',
            q: 'What concept allows analysts to drill down into data and examine different levels of information that may be crucial in diagnostic analytics?',
            options: ['Granularity', 'Interpretability', 'Completeness', 'Transparency'],
            a: 0,
        },
        {
            id: 15,
        ...
        },
        {
            ...
            options: ['Qualitative data', 'Continuous data', 'Imputed data', 'Big data'],
            a: 3,
        },
        {
            id: 18,
        ...
        },
        {
            ...
            options: ['List', 'One-dimensional Array', 'Series', 'Table'],
            a: 3,
        },
        {
            id: 23,
        ...
        },
        {
            ...
            options: ['Motivated Bias', 'Sampling bias', 'Confirmation Bias', 'Anchoring bias'],
            a: 1,
        },
        {
            id: 28,
        ...
        },
        {
            ...
            type: 'MCQ',
            q: "Which area of a PivotTable should you use to create a vertical list of unique values from a specific field?<br><span style='font-size: 13px; color: #64748b;'>1 point</span>",
            options: ['Columns', 'Rows', 'Filters', 'Values'],
            a: 1,
            marks: 1,
        },
        {
            ...
            options: ['Score=true', 'Score="&"', 'Score= 7"', 'Score=String[7]'],
            a: 1,
        },
        {
            id: 36,
            ...
            options: ['Table', 'Graph', 'List', 'Multi-dimensional'],
            a: 2,
        },
        {
            id: 37,
            ...
            options: ['Ordinal Data', 'Quantitative data', 'Qualitative data', 'Metadata'],
            a: 1,
        },
        {
            id: 38,
            ...
            options: ['Option D', 'Option B', 'Option A', 'Option C'],
            optionImages: [
        ...
        },
        {
            ...
            type: 'MCQ',
            q: 'You are analyzing sales activity that occurs on national holidays.<br><br>What level of data granularity will enable you to perform the most precise analysis?',
            options: ['Hours', 'Months', 'Years', 'Days', 'Weeks'],
            a: 0,
        },
        {
            id: 40,
    ...
    da_mock2: [
        {
            ...
            options: ['Qualitative data', 'Ordinal data', 'Metadata', 'Quantitative data'],
            a: 3,
        },
        {
            id: 2,
            ...
            options: ['Imputed Data', 'Continuous data', 'Big Data', 'Qualitative Data'],
            a: 2,
        },
        {
            id: 3,
        ...
        },
        {
            ...
            options: ['Table', 'Multi-dimensional array', 'Graph', 'List'],
            a: 3,
        },
        {
            id: 25,
        ...
        },
        {
            ...
            options: ['572,000', '562,000', '552,000', '538,000'],
            a: 1,
        },
        {
            id: 27,
        ...
        },
        {
            ...
            options: ['Table', 'One-dimensional array', 'List', 'Series'],
            a: 0,
        },
        {
            id: 34,
            ...
            options: ['Completeness', 'Granularity', 'Interpretability', 'Transparency'],
            a: 1,
        },
        {
            id: 35,
        ...
        },
        {
            ...
            options: ['Years', 'Days', 'Hours', 'Months', 'Weeks'],
            a: 2,
        },
        {
            id: 38,
    ...
    da_mock3: [
        ...
        },
        {
            ...
            img: 'sales_by_year_column.png',
            options: ['Disaggregating', 'Unpivoting', 'Pivoting', 'Distributing'],
            a: 0,
            marks: 1,
        },
        {
        ...
        },
        {
            ...
            options: ['Bubble chart', 'Area chart', 'Scatter chart', 'Waterfall chart'],
            a: 0,
            marks: 2,
        },
        {
        ...
        },
        {
            ...
            options: ['Column delimiter', 'Row delimiter', 'Data formatter', 'Text qualifier'],
            a: 3,
            marks: 2,
        },
        {
        ...
        },
        {
            ...
            labels: ['Qualitative Data', 'Unstructured Data', 'Metadata', 'Structured Data'],
            a: {
                "An archive called 'Spring Sales Campaign' that contains svg documents, retouched images and the company style guide as pdf file":
                    'Unstructured Data',
        ...
        },
        {
            ...
            labels: ['Encryption', 'Anonymization', 'Pseudonymization'],
            a: {
        ...
        },
        {
            ...
            type: 'MCQ',
            q: "Person A has 5 coins and person B has 10 coins.<br><br>Which type of data does the number of coins represent?<br><span style='font-size: 13px; color: #64748b;'>1 point</span>",
            options: ['Qualitative data', 'Quantitative data', 'Ordinal data', 'Metadata'],
            a: 1,
            marks: 2,
        },
        {
