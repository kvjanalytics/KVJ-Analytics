module.exports = {
    ...
    "da_mock3": [
        ...
        },
        {
            ...
            "options": [
                "Importing a CSV into a data warehouse",
                "Converting data types or structures",
                "Running a SQL query to see data",
                "Backing up a database"
            ],
            "a": 1
        ...
        },
        {
            ...
            "marks": 1,
            "type": "MCQ",
            "q": "The visualization below displays sales data for two salespeople. A conclusin indicates that Salesperson 1 has a higher lead to sale rate than salesperson 2.<br><br>(A lead to sales rate is the number of actual sales divided by the number of attempted sales)<br><br>You need to determine the accuracy of this conclusin. What should you conclude? (1 Mark)",
            "img": "sales_lead_comparison.png",
            "options": [
                "The conclusion is accurate",
                "The conclusion is inaccurate because the visualization is missing sales and lead data",
