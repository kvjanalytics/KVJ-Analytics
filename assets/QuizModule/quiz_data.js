const quizData = {
    ...
    "mock2": [
    {
        "id": 1,
        "type": "DD",
        "q": "<strong>Unit Testing:</strong> You are developing a Python application that requires unit testing. You need to:<br>\u2022 Import the correct module.<br>\u2022 Verify that a value is an instance of a specific class.<br><br>Complete the code by selecting the correct option from each drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct selection.</span>",
        "code": "[b1] unittest\nclass TestExample(unittest.TestCase):\n    def test_instance(self):\n        self.[b2](5, int)\n\nif __name__ == \"__main__\":\n    unittest.main()",
        "options": [
            [
                "define",
    ...
    },
    {
        "id": 2,
        "type": "MCQ",
        "q": "<strong>Commenting:</strong> You are part of a development team maintaining a large Python project. You need to add notes in your code so other developers can understand its purpose and logic.<br><br>What is the correct way to add a single-line comment in Python?",
        "options": [
            "Use /* comment */",
            "Use <!-- comment -->",
            "Use # comment",
    ...
    },
    {
        "id": 3,
        "type": "DD",
        "q": "<strong>Random Number Generation:</strong> You are writing a program that assigns a random room number. The program must:<br>\u2022 Ensure that the room number is not already assigned.<br>\u2022 Generate a new random number if it is already in use.<br><br>Complete the code by selecting the correct option from the drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct selection.</span>",
    ...
    },
    {
        "id": 4,
        "type": "DD",
        "q": "<strong>File Operations:</strong> A company requires a program that:<br>\u2022 Opens a file named report.txt.<br>\u2022 Writes the text \"End of listing\" into the file.<br><br>Complete the code by selecting the correct option from each drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct selection.</span>",
    ...
    },
    {
        "id": 5,
        "type": "DD",
        "q": "<strong>Error Handling:</strong> You are writing a program that:<br>\u2022 Prompts the user for a number.<br>\u2022 Converts the input to an integer.<br>\u2022 Handles invalid input without crashing.<br><br>Complete the code by selecting the correct option from the drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct selection.</span>",
    ...
    },
    {
        "id": 6,
        "type": "DD",
        "q": "<strong>File Check:</strong> You are developing a file-processing program. Before opening a file, the program must:<br>\u2022 Verify that the file exists.<br>\u2022 Read and display its contents if it exists.<br><br>Complete the code by selecting the correct option from each drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct selection.</span>",
        "code": "import os\nif [b1](\"data.txt\"):\n    file = open(\"data.txt\", \"r\")\n    print(file.[b2]())\n    file.close()",
        "options": [
            [
                "os.path.exists",
    ...
    },
    {
        "id": 7,
        "type": "DND",
        "q": "<strong>Prime Number Check:</strong> You are building a program that prints all prime numbers between 2 and 20. The program must:<br>\u2022 Loop through numbers from 2 to 20.<br>\u2022 Determine whether each number is prime.<br>\u2022 Stop checking a number once a divisor is found.<br><br>Complete the code by moving the appropriate code segment into the correct location.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct placement.</span>",
    ...
    },
    {
        "id": 9,
        "type": "MCQ",
        "q": "<strong>input() Function:</strong> You are creating a console-based application. You use the following statement:<br><br>What does this statement do?",
        "code": "data = input()",
        "options": [
    ...
    },
    {
        "id": 10,
        "type": "TF",
        "q": "<strong>Function Defaults:</strong> You are reviewing the following function.<br><br>For each statement below, select True or False.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct answer.</span>",
    ...
    },
    {
        "id": 11,
        "type": "DD",
        "q": "<strong>While Loops:</strong> You are writing a program that repeatedly accepts user input. The program must:<br>\u2022 Prompt the user to enter a word.<br>\u2022 Display the number of characters in the word.<br>\u2022 Continue until the user enters \"QUIT\".<br><br>Complete the code by selecting the correct option from the drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct selection.</span>",
    ...
    },
    {
        "id": 12,
        "type": "TF",
        "q": "<strong>Conditional Logic:</strong> You are reviewing the following conditional statements.<br><br>For each statement below, select True or False.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct answer.</span>",
        "code": "if num1 == num2:\n    print(\"Equal\")\nif num1 < num2:\n    print(\"Less\")\nif num1 > num2:\n    print(\"Greater\")\nif num2 == num1:\n    print(\"Same\")",
        "options": [
    ...
    },
    {
        "id": 13,
        "type": "DD",
        "q": "You are developing a function that counts how many words in a list contain a specific letter.<br><br>Complete the code by selecting the correct option from each drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct selection.</span>",
    ...
    },
    {
        "id": 17,
        "type": "DD",
        "q": "You are creating a function that reverses a string.<br><br>Complete the code by selecting the correct option from the drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct selection.</span>",
    ...
    },
    {
        "id": 18,
        "type": "TF",
        "q": "You are reviewing the following function.<br><br>For each statement below, select True or False.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct answer.</span>",
    ...
    },
    {
        "id": 23,
        "type": "DND",
        "q": "You are developing a program that processes numbers from 1 to 10. The program must:<br>\u2022 Stop the loop immediately when the number 7 is encountered.<br><br>Complete the code by moving the correct code segment into the blank.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct placement.</span>",
    ...
    },
    {
        "id": 25,
        "type": "TF",
        "q": "You are reviewing the following Python code:<br><br>For each statement below, select True or False.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct answer.</span>",
        "code": "score = 75\nif score >= 50:\n    print(\"Pass\")\nelse:\n    print(\"Fail\")",
        "options": [
    ...
    },
    {
        "id": 31,
        "type": "SHORT",
        "q": "Review the following code:<br><br>How many lines of output will be printed?<br><span style='font-size: 15px; font-style: italic;'>Enter the number as an integer.</span>",
    ...
    "mock3": [
    {
        "id": 1,
        "type": "DD",
        "q": "<strong>File Operations:</strong> You are developing a Python program that stores log information in a file. The program must:<br>\u2022 Open a file named log.txt<br>\u2022 Append new messages without deleting existing data<br><br>Complete the code by selecting the correct option from each drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct selection.</span>",
        "code": "file = open(\"log.txt\", \"[b1]\")\nfile.[b2](\"System started\")\nfile.close()",
        "options": [
            [
                "r",
    ...
    },
    {
        "id": 2,
        "type": "MCQ",
        "q": "<strong>List Membership:</strong> You are reviewing code written by a developer that checks whether a number exists in a list.<br><br>What will the program output?",
        "code": "numbers = [10, 20, 30, 40]\nprint(20 in numbers)",
        "options": [
            "False",
            "True",
    ...
    },
    {
        "id": 3,
        "type": "DND",
        "q": "<strong>Loop Control:</strong> You are developing a program that processes numbers from 1 to 10. The program must:<br>\u2022 Stop the loop immediately when the number 7 is encountered.<br><br>Complete the code by moving the correct code segment into the blank.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for correct placement.</span>",
        "code": "for i in range(1, 11):\n    if i == 7:\n        [target1]\n    print(i)",
        "options": [
            "break",
            "continue",
    ...
    },
    {
        "id": 4,
        "type": "DD",
        "q": "<strong>List Methods:</strong> You are creating a program that stores student marks. The program must:<br>\u2022 Add a new mark to the list<br>\u2022 Sort the list<br><br>Complete the code by selecting the correct option from each drop-down list.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct selection.</span>",
        "code": "marks = [70, 85, 60]\nmarks.[b1](90)\nmarks.[b2]()\nprint(marks)",
        "options": [
            [
                "append",
    ...
    },
    {
        "id": 5,
        "type": "TF",
        "q": "<strong>Conditional Logic:</strong> You are reviewing the following Python code:<br><br>For each statement below, select True or False.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct answer.</span>",
        "code": "score = 75\nif score >= 50:\n    print(\"Pass\")\nelse:\n    print(\"Fail\")",
        "options": [
            "The program prints Pass when score is 75.",
            "The program prints Fail when score is below 50.",
    ...
    },
    {
        "id": 7,
        "type": "DD",
        "q": "<strong>Random Range:</strong> You are creating a program that generates a random number between 1 and 100.<br><br>Complete the code by selecting the correct option.",
        "code": "import random\nnum = random.[b1](1,100)\nprint(num)",
        "options": [
            "randint",
            "rand",
    ...
    },
    {
        "id": 8,
        "type": "MCQ",
        "q": "<strong>For Loops:</strong> You are reviewing the following code:<br><br>What is the output?",
        "code": "for i in range(3):\n    print(i)",
        "options": [
            "1 2 3",
            "0 1 2",
    ...
    },
    {
        "id": 9,
        "type": "TF",
        "q": "<strong>Conditional Logic:</strong> You are reviewing the following code:<br><br>Select True or False.",
        "code": "x = 10\nif x > 5:\n    print(\"High\")\nelse:\n    print(\"Low\")",
        "options": [
            "The program prints High.",
            "The program prints Low when x = 10.",
    ...
    },
    {
        "id": 10,
        "type": "DD",
        "q": "<strong>Membership Test:</strong> You are writing a program that checks whether a number exists in a list.<br><br>Complete the code.",
        "code": "numbers = [5,10,15]\nif 10 [b1] numbers:\n    print(\"Found\")",
        "options": [
            "in",
            "is",
    ...
    },
    {
        "id": 11,
        "type": "SHORT",
        "q": "<strong>Nested Loops:</strong> Review the following code:<br><br>How many lines of output will be printed?<br><span style='font-size: 15px; font-style: italic;'>Enter the number as an integer.</span>",
        "code": "for i in range(2):\n    for j in range(2):\n        print(i,j)",
        "a": "4"
    },
    {
        "id": 12,
        "type": "DD",
        "q": "<strong>While Loops:</strong> You are creating a loop that prints numbers until 5.<br><br>Complete the code.",
        "code": "x = 1\n[b1] x <= 5:\n    print(x)\n    x += 1",
        "options": [
            "if",
            "for",
    ...
    },
    {
        "id": 13,
        "type": "MCQ",
        "q": "<strong>Function Definition:</strong> You are teaching a new colleague how to build reusable components in Python.<br><br>Which keyword defines a function?",
        "options": [
            "function",
            "define",
            "def",
    ...
    },
    {
        "id": 14,
        "type": "SHORT",
        "q": "<strong>Utility Functions:</strong> You are reviewing a basic math utility function in a financial application.<br><br>What is the output of this code?",
        "code": "def add(a,b):\n    return a+b\nprint(add(3,7))",
        "a": "10"
    },
    {
        "id": 15,
        "type": "TF",
        "q": "<strong>Greeting Logic:</strong> You are implementing a default greeting for a user profile system.<br><br>Review the following code and select True or False for each statement.",
        "code": "def greet(name=\"Student\"):\n    print(\"Hello\",name)",
        "options": [
            "greet() prints Hello Student",
            "greet(\"Ana\") prints Hello Ana",
    ...
    },
    {
        "id": 16,
        "type": "MCQ",
        "q": "<strong>Command Line Processing:</strong> You are developing a script that processes color themes from the command line.<br>Program execution:<br><code>python script.py Red Blue</code><br><br>What is the output?",
        "code": "import sys\nprint(sys.argv[1])",
        "options": [
            "script.py",
            "Red",
    ...
    },
    {
        "id": 17,
        "type": "DD",
        "q": "<strong>Slicing & Indexing:</strong> You are building a text parser that needs to extract the first letter of a company name.<br><br>Complete the code that prints the first character of a string.",
        "code": "text = \"Python\"\nprint(text[[b1]])",
        "options": [
            "0",
            "1",
    ...
    },
    {
        "id": 18,
        "type": "TF",
        "q": "<strong>Code Documentation:</strong> You are reviewing the coding standards for a new team project regarding code documentation.<br><br>Select True or False for each statement.",
        "code": "# calculate total\ntotal = 10 + 5",
        "options": [
            "Comments are ignored during execution.",
            "Comments improve code readability.",
    ...
    },
    {
        "id": 19,
        "type": "MCQ",
        "q": "<strong>Order of Operations:</strong> You are debugging an automated billing formula that calculates a total including flat fees and multipliers.<br><br>Evaluate the following expression. What is the output?",
        "code": "print(10 + 5 * 2)",
        "options": [
            "30",
            "20",
    ...
    },
    {
        "id": 20,
        "type": "DD",
        "q": "<strong>File Operations:</strong> You are updating a data export tool that must overwrite previous export files with new data.<br><br>Complete the code to overwrite file contents.",
        "code": "file = open(\"data.txt\",\"[b1]\")\nfile.write(\"Hello\")\nfile.close()",
        "options": [
            "r",
            "a",
    ...
    },
    {
        "id": 21,
        "type": "MCQ",
        "q": "<strong>Random Elements:</strong> You are developing a lottery application that selects a winner from a list of predefined grades.<br><br>What does this program do?",
    ...
    },
    {
        "id": 22,
        "type": "TF",
        "q": "<strong>Comparison Operators:</strong> You are working on a logic controller that compares sensor threshold values.<br><br>Select True or False for each statement.",
        "code": "print(10 > 5)",
        "options": [
            "Output is True",
    ...
    },
    {
        "id": 23,
        "type": "SHORT",
        "q": "<strong>Inventory Counting:</strong> You are developing an inventory system and need to determine the total number of items currently in stock.<br><br>What is the printed answer?",
        "code": "nums = [1,2,3,4,5]\nprint(len(nums))",
        "a": "5"
    },
    {
        "id": 24,
        "type": "DD",
        "q": "<strong>Dictionary Access:</strong> You are writing a program to extract the name from a JSON payload containing student records.<br><br>Complete the code.",
    ...
    },
    {
        "id": 25,
        "type": "TF",
        "q": "<strong>Data Structures (Sets):</strong> You are designing a data deduplication routine and have decided to use Sets.<br><br>Select True or False for each statement concerning Sets.",
        "options": [
    ...
    },
    {
        "id": 26,
        "type": "MCQ",
        "q": "<strong>Tuples:</strong> You are storing fixed configuration coordinates that must not be changed during execution. You choose to use a tuple.<br><br>Which statement describes tuples?",
        "options": [
            "Mutable sequence",
            "Immutable sequence",
            "Unordered structure",
    ...
    },
    {
        "id": 27,
        "type": "TF",
        "q": "<strong>Memory Identity:</strong> You are investigating memory optimization techniques and reviewing variable assignments.<br><br>Select True or False for each statement.",
        "code": "a = 10\nb = 10\nprint(a is b)",
        "options": [
            "Output may be True",
    ...
    },
    {
        "id": 28,
        "type": "DD",
        "q": "<strong>Exception Handling:</strong> You are building a robust calculation engine that must safely handle unexpected mathematical operations without crashing.<br><br>Complete the code.",
    ...
    },
    {
        "id": 29,
        "type": "TF",
        "q": "<strong>Database Cleanup:</strong> You are finalizing a database connection script that must guarantee cleanup processes execute.<br><br>Select True or False concerning the finally block.",
        "options": [
    ...
    },
    {
        "id": 30,
        "type": "DD",
        "q": "<strong>Unit Testing:</strong> You are writing automated tests for a data processing pipeline to strictly ensure variable types.<br><br>Complete the test statement.",
        "code": "self.[b1](5, int)",
        "options": [
            "assertTrue",
            "assertEqual",
    ...
    },
    {
        ...
        "type": "DND",
        "q": "<strong>Operator Precedence:</strong> You are writing a Python application that includes multiple operations on the same line of code. You need to determine the correct order of operations.<br>Move the type of operation from the list on the left to the correct locations on the right, with the operation performed first at the top and the operation performed last at the bottom.<br><span style='font-size: 15px; font-style: italic;'>Note: You will receive partial credit for each correct match.</span>",
        "code": "<div class='dnd-grid'><div>1st Operation:</div> [target1]<div>2nd Operation:</div> [target2]<div>3rd Operation:</div> [target3]<div>4th Operation:</div> [target4]<div>5th Operation:</div> [target5]<div>6th Operation:</div> [target6]</div>",
        "options": [
