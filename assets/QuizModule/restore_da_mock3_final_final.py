...
# Define the questions 1-20 from extracted_da_mock3.json
# (I'll just load them from the file to be safe)
...
# Define the questions 21-33 based on my successful updates
q21_33 = [
    {
        "id": 21,
        "type": "MCQ",
...
# Now insert into content
# We want to replace everything from "da_mock3": onwards if it exists,
# or append it if it doesn't.
# Since it's missing, we append.

da_mock3_str = '"da_mock3": ' + json.dumps(full_mock3, indent=8)

# Find the last closing brace of the dataQuizData object
# The file ends with:
#         }]
# };
...
print("Restoration of 1-44 complete.")
